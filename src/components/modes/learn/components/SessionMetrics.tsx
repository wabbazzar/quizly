      ...
      <div className={styles.metricsContainer} data-testid="session-metrics">
        ...
        <div className={styles.metricsGrid}>
          ...
          <div className={styles.metricCard}>
            ...
            <div className={styles.metricDetails}>Max: {maxStreak}</div>
          </div>
          ...
          <div className={styles.metricCard}>
            ...
            <div className={styles.metricDetails}>cards mastered</div>
          </div>
          ...
          <div className={styles.metricCard}>
            ...
            <div className={styles.metricDetails}>elapsed</div>
          </div>
        </div>
      </div>
    );
